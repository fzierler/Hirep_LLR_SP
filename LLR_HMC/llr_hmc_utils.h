...
{ \
  .read={\
    ...
    {"umbrella RM freq", "umbrella RM freq = %d", INT_T, &((varname).umb_RM_freq)},\
    {"umbrella meas freq", "umbrella meas freq = %d", INT_T, &((varname).umb_meas_freq)},\
    {"umbrella therm freq", "umbrella therm freq = %d", INT_T, &((varname).umb_therm_freq)},\
